...
router.get('/admission',Auth.isLogin ,ParentController.renderListAdmission)

router.post('/addstudent', Auth.isTeacher,ParentController.addStudent)

router.get('/student/:id/edit',Auth.isTeacher, StudentController.renderAddMapel)
router.post('/student/:id/edit',Auth.isTeacher ,StudentController.addMapel)
